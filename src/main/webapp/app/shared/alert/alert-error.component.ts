...
export class AlertErrorComponent implements OnDestroy {
  ...
  constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager, translateService: TranslateService) {
    this.errorListener = eventManager.subscribe(
      'jhipsterSampleApplicationTestWifiApp.error',
    ...
    this.httpErrorListener = eventManager.subscribe(
      'jhipsterSampleApplicationTestWifiApp.httpError',
            ...
            if (errorHeader) {
              ...
              for (const fieldError of fieldErrors) {
                ...
                const fieldName = translateService.instant(
                  'jhipsterSampleApplicationTestWifiApp.' + fieldError.objectName + '.' + convertedField
                );
